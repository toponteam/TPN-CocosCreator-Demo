...
const classJavaName = "com/secmtp/cocosjs/ATRewardedVideoAutoAdJSBridge";
export const ATAndroidRewardedVideoAutoAdTS = {
    ...
    addPlacementIds : function (placementIds: any) {
        console.log("secmtp++++++++++ ATAndroidRewardedVideoAutoAdTS Android-addPlacementIds " + placementIds);
    ...
    removePlacementId : function (placementId: any) {
        console.log("secmtp++++++++++ Android-removePlacementId");
    ...
    showAd : function(placementId: string) {
        console.log("secmtp++++++++++ Android-rvautoad_showAd:" + placementId);
    ...
    showAdInScenario : function(placementId: string, scenario: string) {
        console.log("secmtp++++++++++ Android-rvautoad_showAdInScenario:" + placementId + "---" + scenario);
