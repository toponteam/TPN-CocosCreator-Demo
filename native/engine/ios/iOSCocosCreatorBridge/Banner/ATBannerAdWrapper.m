...
//                CGFloat admobBannerWidth = [extraDict[kATBannerAdLoadingExtraInlineAdaptiveWidthKey] doubleValue] / scale;
//                GADAdSize admobSize;
...
static NSString *const kDelegatesBiddingAttemptKey = @"BannerBiddingAttempt";
static NSString *const kDelegatesBiddingFilledKey = @"BannerBiddingFilled";
...
- (void)didStartLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra{
    dispatch_async(dispatch_get_main_queue(), ^{
        NSLog(@"ATBannerAdWrapper::didStartLoadingADSourceWithPlacementID:%@ extra:%@", placementID, extra);
...
- (void)didFinishLoadingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra{
    dispatch_async(dispatch_get_main_queue(), ^{
        NSLog(@"ATBannerAdWrapper::didFinishLoadingADSourceWithPlacementID:%@ extra:%@", placementID, extra);
...
- (void)didStartBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra{
    dispatch_async(dispatch_get_main_queue(), ^{
        NSLog(@"ATBannerAdWrapper::didStartBiddingADSourceWithPlacementID:%@ extra:%@", placementID, extra);
        [ATJSBridge callJSMethodWithString:[NSString stringWithFormat:@"%@('%@', '%@')", self.delegates[kDelegatesBiddingAttemptKey], placementID, [extra jsonFilterString_AnyThinkJS]]];
    });
}

- (void)didFinishBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra{
    dispatch_async(dispatch_get_main_queue(), ^{
        NSLog(@"ATBannerAdWrapper::didFinishBiddingADSourceWithPlacementID:%@ extra:%@", placementID, extra);
        [ATJSBridge callJSMethodWithString:[NSString stringWithFormat:@"%@('%@', '%@')", self.delegates[kDelegatesBiddingFilledKey], placementID, [extra jsonFilterString_AnyThinkJS]]];
    });
}
...
-(void) bannerView:(ATBannerView*)bannerView didAutoRefreshWithPlacement:(NSString*)placementID extra:(NSDictionary *)extra {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [ATJSBridge callJSMethodWithString:[NSString stringWithFormat:@"%@('%@', '%@')", self.delegates[kDelegatesAutoRefreshKey], placementID, [extra jsonFilterString_AnyThinkJS]]];
    });
}
...
-(void) bannerView:(ATBannerView*)bannerView didTapCloseButtonWithPlacementID:(NSString*)placementID extra:(NSDictionary*)extra {
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        [ATJSBridge callJSMethodWithString:[NSString stringWithFormat:@"%@('%@', '%@')", self.delegates[kDelegatesCloseButtonTappedKey], placementID, [extra jsonFilterString_AnyThinkJS]]];
    });
}
