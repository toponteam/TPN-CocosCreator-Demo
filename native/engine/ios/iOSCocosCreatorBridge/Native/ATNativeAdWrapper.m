...
+(void) showNativeWithPlacementID:(NSString*)placementID scene:(NSString*)scene
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if ([metrics[@"parent"] isKindOfClass:[NSDictionary class]]) {
            adFrame = CGRectMake([metrics[@"parent"][@"x"] doubleValue] / scale, [metrics[@"parent"][@"y"] doubleValue] / scale, [metrics[@"parent"][@"width"] doubleValue] / scale, [metrics[@"parent"][@"height"] doubleValue] / scale);
        }
