...
- (void)didStartBiddingADSourceWithPlacementID:(NSString *)placementID extra:(NSDictionary*)extra{
    ...
    NSLog(@"ATInterstitialAdWrapper::didStartBiddingADSourceWithPlacementID:%@ extra:%@,extraStr:%@ kDelegatesBiddingAttemptKey:%@", placementID, extra,[extra jsonFilterString_AnyThinkJS],self.delegates[kDelegatesBiddingAttemptKey]);
