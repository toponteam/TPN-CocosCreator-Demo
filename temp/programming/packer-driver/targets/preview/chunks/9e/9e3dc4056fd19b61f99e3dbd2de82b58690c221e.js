  ...
  return {
    ...
    execute: function () {
      ...
      _export("ATiOSTS", ATiOSTS = {
        ...
        showGDPRConsent: function showGDPRConsent(callbackMethod) {// native.reflection.callStaticMethod(classJavaName, "showGDPRConsentDialog", "(Ljava/lang/String;)V", callbackMethod);
        },
        ...
        setChannel: function setChannel(channel) {// native.reflection.callStaticMethod(classJavaName, "setChannel", "(I)V", channel);
        },
        setSubChannel: function setSubChannel(subChannel) {// native.reflection.callStaticMethod(classJavaName, "setSubChannel", "(I)V", subChannel);
        }
      });
