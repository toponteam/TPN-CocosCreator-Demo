    ...
    execute: function () {
      ...
      _export("ATSplashSDK", ATSplashSDK = {
        ATSplashListener: {
          ...
          onSplashAdLoaded: function onSplashAdLoaded(placementId) {
          ...
          onSplashAdLoadFail: function onSplashAdLoadFail(placementId, errorInfo) {
          ...
          onSplashAdShow: function onSplashAdShow(placementId, callbackInfo) {
          ...
          onSplashAdClose: function onSplashAdClose(placementId, callbackInfo) {
          ...
          onSplashAdClick: function onSplashAdClick(placementId, callbackInfo) {
